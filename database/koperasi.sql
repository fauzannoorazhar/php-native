...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Feb 2017 pada 10.14
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(1000010, 'Horiza Sat7fa', 'CIPATAT', '1981-09-16', 'Bogor', 'Perempuan', 'Anggota', 823456996, 'aktif');
...
--
-- Dumping data untuk tabel `petugas_koperasi`
--
...
(400001, 1000001, 1, 200001, 'Rp. 2.000.000', '2017-01-13', '2017-01-20', '2017-01-13', '2017-01-20', '-'),
...
ALTER TABLE `angsuran`
 ADD PRIMARY KEY (`Id_Angsuran`), ADD KEY `Id_Anggota` (`Id_Anggota`,`Id_Pinjaman`,`Id_Kategori`,`Id_Petugas`), ADD KEY `Id_Pinjaman` (`Id_Pinjaman`), ADD KEY `Id_Kategori` (`Id_Kategori`), ADD KEY `Id_Petugas` (`Id_Petugas`);
...
ALTER TABLE `petugas_koperasi`
 ADD PRIMARY KEY (`Id_Petugas`), ADD KEY `Username` (`Username`);

--
-- Indexes for table `pinjaman`
--
ALTER TABLE `pinjaman`
 ADD PRIMARY KEY (`Id_Pinjaman`), ADD KEY `Id_Anggota` (`Id_Anggota`,`Id_Kategori`,`Id_Petugas`), ADD KEY `Id_Kategori` (`Id_Kategori`,`Id_Petugas`), ADD KEY `Id_Petugas` (`Id_Petugas`), ADD KEY `Id_Petugas_2` (`Id_Petugas`);

--
-- Indexes for table `simpanan`
--
ALTER TABLE `simpanan`
 ADD PRIMARY KEY (`Id_Simpanan`), ADD KEY `Id_Anggota` (`Id_Anggota`,`Id_Petugas`), ADD KEY `Id_Petugas` (`Id_Petugas`);
...
--
ALTER TABLE `anggota`
MODIFY `Id_Anggota` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1000011;
--
-- AUTO_INCREMENT for table `kategori`
--
ALTER TABLE `kategori`
MODIFY `Id_Kategori` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3334;
--
...
--
-- Ketidakleluasaan untuk tabel `petugas_koperasi`
--
ALTER TABLE `petugas_koperasi`
